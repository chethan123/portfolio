...
half after the last request of any kind — `touchGrant` rolls the window only when under half of it
remains, so a request at minute five extends nothing. On top of it, a browser hidden longer than
