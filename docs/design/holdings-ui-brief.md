...
| Coverage under a summed figure | — | A `.cell-sub` inside the `.row-subtotal` / `.row-total` money cells reading "11 of 18". No new class; the existing `.cell-sub` in a place it has not been used before |
