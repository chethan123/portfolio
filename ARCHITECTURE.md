...
and every later statement is checked against it: a settings form open across that capture cannot
disarm it, because the save compares the box against the number it was drawn with (§7.2).
